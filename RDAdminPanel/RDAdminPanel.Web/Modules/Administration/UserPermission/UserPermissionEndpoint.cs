using MyRepository = RDAdminPanel.Administration.Repositories.UserPermissionRepository;
using MyRow = RDAdminPanel.Administration.UserPermissionRow;

namespace RDAdminPanel.Administration.Endpoints;
